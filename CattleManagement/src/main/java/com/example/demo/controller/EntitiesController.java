...
//    }
    @GetMapping("/search")
    public ResponseEntity<Page<Entities>> findAllEntitiesByInDateAndCage(@PageableDefault(size = 10) Pageable pageable,
                                                                         @RequestParam(defaultValue = "0") Integer page,
                                                                         @RequestParam(defaultValue = "", name = "inDate") String inDate,
                                                                         @RequestParam(defaultValue = "", name = "outDate") String outDate,
                                                                         @RequestParam(defaultValue = "", name = "cage") String cage) {
        System.out.println("indate" + inDate);
        System.out.println("cage " + cage);
        System.out.println("1");
...
//        cage = "%" + cage + "%";
        ...
        if (outDate==""){
            ...
            outDate= LocalDate.now().toString();
        }
        Page<Entities> entities = entitiesService.findAllByInDateAndCage22(pageable, cage, inDate, outDate);
